...
public class DeterminanOBE {
    ...
    public static boolean All0rowcol(double[][] m, boolean isRow, int idx){
    ...
    public static void kurangBasis(double[][] m, int row, double[] basis){
        int i;
        for(i=0;i<m[0].length;i++){
            m[row][i] = m[row][i] - basis[i];
        }
    }
    public static void tambahBasis(double[][] m, int row, double[] basis){
        int i;
        for(i=0;i<m[0].length;i++){
            m[row][i] = m[row][i] + basis[i];
        }
    ...
    public static void printBasis(double[] basis){
    ...
    public static void rowKaliConst(double[][] arr, int brs, double n){
        int i;
    ...
    public static void swapRow(double[][] arr, int brs1, int brs2){
    ...
    public static void obe(double[][] m){
